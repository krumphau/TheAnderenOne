	...
	<header id="masthead" class="site-header">
      ...
      <div class="flex-body">
			...
			<div class="flex-column">
				<div class = "align-self-center"><img style = 'float: right; padding-right: 48px; padding-top:40px; height:74px;'  src = "http://3.15.13.29:8000/wp-content/uploads/2020/05/logotype_white@2x-1-e1588619045637.png"/></div>
      </div>
			</div><!--.end flex-body-->
			<?php endif; ?>
