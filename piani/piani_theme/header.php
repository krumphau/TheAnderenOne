...
<div id="page" class="site">
 ...
 <!-- Collapsible content -->
      ...
      <div>
			...
			<div class="flex-row">
				<div style='float: right;'><img style = 'float:right; padding-right: 30px; height:74px;'  src = "http://3.15.13.29:8000/wp-content/uploads/2020/05/logotype_white@2x-1-e1588619045637.png"/></div>
      </div>
			</div><!--.end flex-body-->
			<?php endif; ?>
